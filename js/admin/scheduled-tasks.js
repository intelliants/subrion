Ext.onReady(function()
{
	var grid = new IntelliGrid(
	{
		...
		[
			...
			{name: 'active', title: _t('active'), renderer: intelli.gridHelper.renderer.check, align: intelli.gridHelper.constants.ALIGN_CENTER, width: 50,editor: Ext.create('Ext.form.ComboBox',
			{
				typeAhead: false,
				editable: false,
				lazyRender: true,
