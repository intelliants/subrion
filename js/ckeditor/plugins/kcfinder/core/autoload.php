...
function __autoload($class) {
	$path = IA_HOME . 'js' . IA_DS . 'ckeditor' . IA_DS . 'plugins' . IA_DS . 'kcfinder' . IA_DS;

    if ($class == "uploader")
        require $path . "core/uploader.php";
    elseif ($class == "browser")
        require $path . "core/browser.php";
    elseif (file_exists($path . "core/types/$class.php"))
        require $path . "core/types/$class.php";
    elseif (file_exists($path . "lib/class_$class.php"))
        require $path . "lib/class_$class.php";
    elseif (file_exists($path . "lib/helper_$class.php"))
        require $path . "lib/helper_$class.php";
}
