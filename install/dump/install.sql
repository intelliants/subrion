...
('mail','','Addresses','','divider',0,'',1,'',1,0,''),
('mail','site_email','{install:email}','1','text',0,'Default site email',3,'',1,0,''),
('mail','bcc_email','','1','text',0,'BCC auto emails to',6,'',1,0,''),
('mail','','General','1','divider',0,'',9,'',1,0,''),
('mail','site_from_name','Subrion CMS','1','text',0,'Default mail name',12,'',1,0,''),
('mail','default_email_signature','\r\n<p>______________________________</p>\r\n<p>Thank you,<br>\r\n{%SITE_NAME%} Team<br>\r\n{%SITE_URL%}</p>','1','textarea',0,'Default mail signature',15,'',1,0,''),
...
('mail','smtp_secure','TLS','''TLS'',''SSL''','select',0,'SMTP Secure',36,'',1,0,'mail_function|smtp'),
('mail','smtp_user','','','text',0,'SMTP Server Username',39,'',1,0,'mail_function|smtp'),
('mail','smtp_password','','','password',0,'SMTP Server Password',42,'',1,0,'mail_function|smtp'),
('mail','','Sendmail Settings','','divider',0,'',45,'',1,0,'mail_function|sendmail'),
('mail','sendmail_path','/usr/bin/sendmail','','text',0,'Path to sendmail ',48,'',1,0,'mail_function|sendmail'),
('mail','mimetype','1','''1'',''0''','radio',0,'Send HTML mime-type emails instead of plain text',51,'',1,0,''),
...
('pictures','watermark_opacity','75','','text',0,'Opacity',19,'',1,0,'watermark|1'),
...
('pictures','watermark_text_color','FFFFFF','','text',0,'Text RGB color',18,'',1,0,'watermark_type|text'),
('pictures','watermark_text_size','20','','text',0,'Text size',19,'',1,0,'watermark_type|text'),
