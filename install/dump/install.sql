...
CREATE TABLE `{install:prefix}fields` (
	...
	`type` enum('text','url','number','date','textarea','combo','radio','checkbox','storage','image','pictures','currency','tree','iconpicker','switcher') NOT NULL default 'text',
...
('financial', 'invoice_logo', '', '', 'image', 12, '', 0, '{\"wysiwyg\":0,\"code_editor\":0,\"show\":\"\",\"multilingual\":0}'),
...
('field_type_switcher','Switches ON/OFF','admin'),
