...
('mail','smtp_secure','TLS','''TLS'',''SSL''','select',0,'SMTP Secure',10,'',1,0,'mail_function|smtp'),
('mail','smtp_user','','','text',0,'SMTP Server Username',11,'',1,0,'mail_function|smtp'),
('mail','smtp_password','','','password',0,'SMTP Server Password',12,'',1,0,'mail_function|smtp'),
