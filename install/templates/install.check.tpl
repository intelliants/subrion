<?php if (!file_exists(IA_HOME . '.htaccess')): ?>
	<div class="alert alert-error">No .htaccess found in your Subrion core folder. More details <a href="https://www.subrion.com/desk/index.php?/Knowledgebase/Article/View/28/3/no-htaccess-in-subrion-folder" target="_blank">here</a>.</div>
<?php endif ?>
