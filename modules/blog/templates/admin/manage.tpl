			...
			<div class="row">
				...
				<div class="col col-lg-4">
					...
					<div class="input-group thumbnail thumbnail-single with-actions">
						...
						<div class="caption">
							<a class="btn btn-small btn-danger js-cmd-delete-file" href="#" title="{lang key='delete'}" data-file="{$item.image}" data-item="blog_entries" data-field="image" data-id="{$id}"><i class="i-remove-sign"></i></a>
						</div>
					</div>
					{/if}
